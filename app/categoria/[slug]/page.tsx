...
export default async function CategoryPage({params}:{params:Promise<{slug:string}>}){
 ...
 return <main style={{minHeight:"100vh",background:"#f5f5f5",color:"#172554"}}>
  <style>{`*{box-sizing:border-box}body{margin:0}.cat-card{transition:.2s;border:1px solid #e5e7eb}.cat-card:hover{transform:translateY(-2px);box-shadow:0 10px 28px #0002}.cat-card-link{display:flex;flex-direction:column;height:100%;color:inherit;text-decoration:none}.cat-img{height:205px;min-height:205px;max-height:205px;display:flex;align-items:center;justify-content:center;padding:12px;border-bottom:1px solid #eef2f7;overflow:hidden;background:#fff}.cat-img img{display:block;width:auto!important;height:auto!important;max-width:100%!important;max-height:100%!important;object-fit:contain!important}.cat-body{padding:13px;display:flex;flex-direction:column;gap:7px;flex:1;background:#fff}.cat-name{font-size:14px;line-height:1.35;color:#334155;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;min-height:38px}.cat-price{display:block;font-size:22px;color:#172554}.cat-platform{color:#00a650;font-weight:800;font-size:12px}.cat-button{margin-top:auto;display:block;text-align:center;background:#3483fa;color:#fff;padding:10px 12px;border-radius:8px;font-size:12px;font-weight:800}.cat-hint{font-size:12px;color:#64748b;margin-top:6px}@media(max-width:720px){.cat-head{padding:18px 12px!important}.cat-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:9px!important}.cat-wrap{padding:18px 9px 36px!important}.cat-img{height:145px!important;min-height:145px!important;max-height:145px!important;padding:7px!important}.cat-body{padding:9px!important;gap:5px!important}.cat-name{font-size:11px!important;min-height:30px!important}.cat-price{font-size:18px!important}.cat-button{font-size:10px!important;padding:8px 6px!important}}`}</style>

...
export default async function VendedorPage() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#f5f7fb", color: "#172554" }}>
      <div style={{ display: "flex", minHeight: "100vh", flexWrap: "wrap" }}>
        <aside style={{ width: 240, background: "#19345f", color: "white", padding: "28px 20px", boxSizing: "border-box", flexShrink: 0 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, paddingBottom: 24, borderBottom: "1px solid #ffffff22" }}>
            <div style={{ width: 44, height: 44, borderRadius: 12, background: "#ffe600", color: "#10234c", display: "grid", placeItems: "center", fontWeight: 900 }}>SS</div>
            <div>
              <div style={{ fontWeight: 900 }}>SHILMASTORE</div>
              <div style={{ fontSize: 13, color: "#cbd5e1" }}>Painel do vendedor</div>
            </div>
          </div>

          <nav style={{ display: "grid", gap: 8, marginTop: 24 }}>
            <a href="/vendedor" style={activeNavStyle}>Visão geral</a>
            <a href="/vendedor/produtos/novo" style={navStyle}>Produtos</a>
            <span style={disabledNavStyle}>Pedidos <small>em breve</small></span>
            <span style={disabledNavStyle}>Minha loja <small>em breve</small></span>
            <span style={disabledNavStyle}>Financeiro <small>em breve</small></span>
            <span style={disabledNavStyle}>Configurações <small>em breve</small></span>
          </nav>

          <div style={{ marginTop: 28, paddingTop: 20, borderTop: "1px solid #ffffff22", display: "grid", gap: 8 }}>
            <a href="/" style={navStyle}>Ver vitrine</a>
            <a href="/minha-conta" style={navStyle}>Minha conta</a>
          </div>
        </aside>

        <section style={{ flex: 1, minWidth: 0, padding: "32px 28px" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            <div style={{ display: "flex", justifyContent: "space-between", gap: 16, alignItems: "center", flexWrap: "wrap", marginBottom: 22 }}>
              <div>
                <div style={{ color: "#2563eb", fontSize: 13, fontWeight: 900, letterSpacing: 1.2 }}>MINHA LOJA</div>
                <h1 style={{ margin: "8px 0 4px", fontSize: 36 }}>Painel do vendedor</h1>

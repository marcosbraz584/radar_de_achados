...
type SearchRow = { id:string|null; name:string|null; status:string|null; domain_id:string|null; image:string|null; pictures:string[]; features:string[]; permalink:string|null; offer_item_id:string|null; offer_price:number|null; offer_original_price:number|null; currency_id:string|null; offers_count:number; search_position:number; relevance:number };
